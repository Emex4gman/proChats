...
import 'package:prochats/pages/chatWindow.dart';
import 'package:prochats/screens/conversation.dart';
import 'package:prochats/screens/createGroup.dart';
...
import 'package:prochats/widgets/chat_item.dart';
import 'package:prochats/widgets/customDialog.dart';
import 'package:prochats/widgets/displayChatsMenuItem.dart';
      ...
      body: TabBarView(
        ...
        return  ListView.separated(
            ...
            Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Conversation(chatId: ds.documentID, groupSportCategory: ds.data['category'],chatOwnerId: ds.data['createdBy'],groupTitle: ds.data['title']?? "",approvedGroupsJson: ds.data['approvedGroupsJson'], userId: userId, senderMailId: email,chatType: "", waitingGroups: waitingGroups, approvedGroups: approvedGroups),
                        ),
                      );
                   },
                child: ChatMenuIcon(
